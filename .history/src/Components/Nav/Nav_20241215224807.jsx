      ...
      <div>
        ...
        <div>
          ...
          <div className=" absolute z-10 top-[17.7%] h-[100%] left-[38.5%] w-[12%]  " >
            {secondModal && (
              <div className=" bg-[#fff]  p-[1.5rem] flex flex-col gap-[10px] border-2 border-border rounded-[10px] "id="dropdown_menu">
              ...
              <ul>
                  <li><a href="#">menu</a></li>
                  <li><a href="#">men</a></li>
                  <li><a href="#" className="me">me <i className="fas fa-caret-right"></i></a>
                      <div class="mine">
                          <ul>
                              <li><a href="#">hi</a></li>
                              <li><a href="#">hi</a></li>
