    ...
    <div>
      <div className="">
        <ul className=" flex items-center justify-center gap-[4rem] p-[rem] font-[500] text-[17px] mb-6 ">
          ...
          <div className="group">
            <li
              className=" hover hover:border-b-primary border-transparent border-b-4 border-[#fff] pb-[1rem] cursor-pointer  transition duration-500 ease-in-out hover:text-primary   "
        ...
        <div className="" >
          <div className=" absolute z-10 top-[25 %] h-[100%] right-[16.5%] w-[67%]  ">
            <divclassName="justify-center flex gap-[3rem] p-[1rem] border-2 border-border bg-[#fff] rounded-[10px]  group-hover:flex ">
              id="name"  {categories.map((index) => (
                <div className="key" key={index.id}>
