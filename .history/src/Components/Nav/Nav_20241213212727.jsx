          ...
          <div className=" absolute z-10 top-[17.7%] h-[100%] left-[57%] w-[12%] ">
            ...
            <div className="relative z-5" >
                    <div className="  flex align-middle justify-center ">
                      <img className="rounded-[10px]" src={item.ima} alt="" />
                    </div>
                    <div className=" absolute z-10 top-[15%] left-32 w-[30%]   ">
                      <p className=" font-[500] text-primary text-[40px] tracking-wide "> {item.name} </p>
                      <p className=" text-[60px] font-bold capitalize ">{item.category}</p>
                      <p className=" text-text text-[30px] font-bold "> starting at  $ <span className="text-[35px]">20</span>.00 </p>
                      <button className="bg-primary  text-[#fff] px-[1.5rem] py-[0.7rem] mt-6 rounded-md hover:bg-[#000] hover:text-[#fff] cursor-pointer ">{item.button}</button>
                    </div>
                  </div>
            </div>
    </div>
